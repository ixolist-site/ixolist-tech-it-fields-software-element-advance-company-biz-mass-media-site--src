...
categories: ['Биткоин', 'Эфириум', 'Блокчейн', 'Криптовалюта', 'Децентрализация', 'Смарт-контракты', 'NFT', 'Альткоин', 'Майнинг', 'Кошелек', 'Токен', 'Цифровой актив', 'ICO', 'DeFi', 'Подтверждение-работы', 'Подтверждение-доли', 'Консенсус', 'Хардфорк', 'Софтфорк', 'Хеширование']
